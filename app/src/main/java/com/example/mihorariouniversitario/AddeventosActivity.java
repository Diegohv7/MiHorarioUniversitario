...
public class AddeventosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addeventos);
        ...
        guardar=(Button) findViewById(R.id.btnGuaradar);
